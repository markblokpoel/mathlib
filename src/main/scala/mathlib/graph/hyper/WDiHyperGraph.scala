...
/** Represents a weighted directed hyper graph.
  ...
  */
case class WDiHyperGraph[T](
    override val vertices: Set[Node[T]],
    override val edges: Set[WDiHyperEdge[Node[T]]]
) extends HyperGraph[T, WDiHyperEdge[Node[T]]] {
...
case object WDiHyperGraph {
  ...
  /** Creates a weighted directed hyper graph from a set of hyper edges.
    ...
    */
  def apply[T, X: ClassTag](edges: Set[WDiHyperEdge[Node[T]]]): WDiHyperGraph[T] =
    WDiHyperGraph.empty + edges
